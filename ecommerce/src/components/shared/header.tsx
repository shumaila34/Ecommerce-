      ...
      <div className="bg-background shadow-sm">
        <div className="container mx-auto px-4">
          <div className="flex items-center h-16 md:h-20 justify-between gap-4">
            {/* Logo */}
            <Link href="/" className="text-xl md:text-2xl font-bold text-primary hover:opacity-90 transition-opacity">
              Daxbazar
            </Link>

            {/* Search (Hidden on Mobile) */}
            <form onSubmit={handleSearch} className="flex-1 hidden lg:flex relative">
            ...
            <nav className="flex items-center gap-4 md:gap-6">
              ...
              <Link href="/account" className="hover:opacity-80 transition-opacity hidden sm:block">
